    ...
    <div class="wrapper">
            ...
            <div class="container">
                <div class="row">  
                    <div class="col-md-12 text-left">
                        <h1>CUFS LINK</h1>
                        <p>Pre-Qualify for a Mortgage Purchase or Refinance</p>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->
        </section><!-- end section -->
        ...
        <section class="section white">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-widget list-styles pb20">
					 ...
					 <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="team-member">
                            <div class="entry">
                                <img src="images/staff/whitney-cannon.jpg" alt="Whitney Cannon">
                                <div class="magnifier">
                                    <div class="visible-buttons">
                                        <a href="https://hosting.bytesoftware.com/apps/BCP_40583?LO=Whitney%20Cannon" target="_blank"><i class="fa fa-pencil-square-o"></i><br><strong style="color: #ffffff;">Apply with.</strong></a>
                                  </div><!-- end buttons -->
                              </div><!-- end magnifier -->
                          </div><!-- end entry -->
                          <h3 align="center"> <a href="https://hosting.bytesoftware.com/apps/BCP_40583?LO=Whitney%20Cannon" target="_blank" >Whitney Cannon</a></h3>
                          <p>&nbsp;</p>
                        ...
                        <div class="team-member">
                          ...
                          <h3 align="center"> <a href="https://hosting.bytesoftware.com/apps/BCP_40583/?LO=MarkAgee" target="_blank">Mark Agee</a></h3>
                          <p>&nbsp;</p>
                        ...
                        <div class="team-member">
                          ...
                          <h3 align="center"> <a href="https://hosting.bytesoftware.com/apps/BCP_40583?LO=KenObiecunas" target="_blank">Ken Obiecunas</a></h3>
                          <p>&nbsp;</p>
					 ...
					 <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="team-member">
                          <div class="entry">
                                ...
                                <div class="magnifier">
                                    <div class="visible-buttons">
                                        <a href="https://hosting.bytesoftware.com/apps/BCP_40583" target="_blank"><i class="fa fa-pencil-square-o"></i><br><strong style="color: #ffffff;">Apply with.</strong></a>
                                  </div><!-- end buttons -->
                            </div><!-- end magnifier -->
                          </div><!-- end entry -->
                         <h3 align="center"><a href="https://hosting.bytesoftware.com/apps/BCP_40583" target="_blank">I don't know yet</a></h3> 
                             <p>&nbsp;</p>
